  ...
  return (
    <div>
      <Breadcrumb
        ...
        items={[
          {
            href: '/user/channel-subscription',
            title: 'Channel Subscription',
          },
          {
            href: '/user/channel-subscription/telegram',
            title: 'Telegram',
          },
          {
            title: 'Subscribe',
        ...
        <Timeline>
          <Timeline.Item>
            <div>
              ...
              <p style={{ fontSize: 16, fontWeight: 700 }}>
                Masukkan setting name untuk Telegram anda
              </p>
              <div
          ...
          <Timeline.Item>
            <div>
              ...
              <p style={{ fontSize: 16, fontWeight: 700 }}>
                Hubungkan akun bisnis Telegram Anda
              </p>
              ...
              <Form.Item style={{ marginTop: '1em' }}>
                <Button block type="primary" htmlType="submit">
                  Subscription Telegram by Omnix
                </Button>
              </Form.Item>
            </div>
          </Timeline.Item>
